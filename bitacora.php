...
<div class="modal fade" id="bit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      ...
      <div class="row">
        &nbsp;&nbsp;&nbsp;&nbsp;
        <input type="text" class="col-xm-4" id="filtro-U" onkeyup="filtraruser()" placeholder="Buscar por usuario.." title="Type in a name">&nbsp;&nbsp;
        <input type="text" class="col-xm-4" id="filtro-T" onkeyup="filtrartabla()" placeholder="Buscar por tablas.." title="Type in a name">&nbsp;&nbsp;
        <input type="text" class="col-xm-4" id="filtro-A" onkeyup="filtraraccion()" placeholder="Buscar por acciones.." title="Type in a name">&nbsp;&nbsp;
      </div>
...
<script>
    function filtraruser() {
      ...
      input = document.getElementById("filtro-U");
...
<script>
    function filtrartabla() {
      var input, filter, table, tr, td, i, txtValue;
      input = document.getElementById("filtro-T");
      filter = input.value.toUpperCase();
      table = document.getElementById("cont");
      tr = table.getElementsByTagName("tr");
      for (i = 0; i < tr.length; i++) {
...
<script>
    function filtraraccion() {
      var input, filter, table, tr, td, i, txtValue;
      input = document.getElementById("filtro-A");
      filter = input.value.toUpperCase();
      table = document.getElementById("cont");
      tr = table.getElementsByTagName("tr");
      for (i = 0; i < tr.length; i++) {
